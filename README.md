...
* One of the challenging parts was implementing the multiplier which was used in the original design, you can see the schema of it in [here](Multiplier_bitwise_pe.jpg)
